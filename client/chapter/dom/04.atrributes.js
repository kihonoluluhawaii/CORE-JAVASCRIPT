...
first.dataset.name = 'tiger'; //<-좀더 정확한 방법
...
function getAttr(node, prop) {
  ...
  if (typeof prop !== 'string') {
    throw new Error('getAttr 함수의 두번째 인수는 문자 타입 이어야 합니다.');
  }
...
function setAttr(node, prop, value) {
  ...
  if (typeof prop !== 'string' && typeof active !== 'string') {
    throw new Error(
      'setAttr함수의 두번째, 세번째 인수는 문자 타입 이어야 합니다.'
    );
  }
