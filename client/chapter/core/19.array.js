...
// 배열 복사
// let copiedArray = friends;  //  참조복사 (같은 대상을 가르키는 위험한 복사)
// let copiedArray = [...friends]; // 얕은 복사        spread syntax
let copiedArray = friends.slice(); // 얕은 복사   (아무것도 도려내지않고 복제)
