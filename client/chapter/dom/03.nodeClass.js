...
// first.innerHTML = ''; //first 의 내용물을 공백을 사용하여 지워줌

first.innerHTML += '<strong>멋쟁이</strong> 사자처럼'; //h1뒤에 추가
// - textContent
// * 요소 내의 텍스트에 접근
// * 태그는 제외하고 오로지 텍스트만 추출

first.textContent = '멋사 9기 친구들'; // 태그는 넣을 수 없음. 강제로 넣으면 태그전체가 출력
//setter
